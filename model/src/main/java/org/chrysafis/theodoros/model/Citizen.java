package org.chrysafis.theodoros.model;
...
{	
    ...
    private String citizenGender = null;
    ...
    public static class CitizenBuilder
    {
        ...
        public CitizenBuilder(String tautotita, String citizenName, String citizenSurname, String citizenGender,
                 String citizenDoB, int citizenAfm, String citizenAddress) 
        {
        ...
        public CitizenBuilder Tautotita(String value) {
        	this.tautotita = value;
        	return this;
        }

        public CitizenBuilder CitizenName(String value) {
        	this.citizenName = value;
        	return this;
        }

        public CitizenBuilder CitizenSurname(String value) {
        	this.citizenSurname = value;
        	return this;
        }

        public CitizenBuilder CitizenGender(String value) {
        	this.citizenGender = value;
        	return this;
        }

        public CitizenBuilder CitizenDoB(String value) {
        	this.citizenDoB = value;
        	return this;
        }
